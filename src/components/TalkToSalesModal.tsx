        ...
        <div className="flex flex-col h-full">
            <div className="px-6 py-6 border-b border-gray-100 bg-gray-50/50">
                ...
                <div className="flex gap-2 mt-4">
                  <div className={`h-1 flex-1 rounded transition-colors ${step === 1 ? 'bg-[#B87333]' : 'bg-gray-200'}`} />
                  <div className={`h-1 flex-1 rounded transition-colors ${step === 2 ? 'bg-[#B87333]' : 'bg-gray-200'}`} />
                </div>
            </div>
            ...
            <div className="p-6 overflow-y-auto">
                 {step === 1 ? (
                   ...
                   <form onSubmit={handleStep1Next} className="space-y-5">
                      ...
                      <Button type="submit" className="w-full bg-[#B87333] hover:bg-[#a0632a] text-white h-14 mt-6">
                   ...
                   <form onSubmit={handleFinalSubmit} className="space-y-5">
                      {initialData?.interest && formData.interests.includes(initialData.interest) && (
                        <div className="bg-[#F5F1E9] border-2 border-[#B87333] rounded-lg p-4 mb-4">
                      ...
                      <div className="flex gap-3 mt-6">
                        ...
                        <Button
                          type="submit"
                          className="flex-1 bg-[#B87333] hover:bg-[#a0632a] text-white h-14"
