...
export function MobileNav() {
    ...
    return (
        <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px] bg-brand-cream border-l-brand-copper/20 overflow-y-auto">
                ...
                <div className="flex flex-col gap-8 pb-10">
                    {navSections.map((section) => {
                        ...
                        const uniqueItems = mobileItems.filter((item, index, self) =>
