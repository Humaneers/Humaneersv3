            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold text-brand-oxford mb-6">
                  From Stealth to Service
                </h2>
                <div className="prose text-brand-slate leading-relaxed space-y-4">
                  <p>
                    Humaneers began in stealth mode, serving a select roster of referral-only
                    clients who needed enterprise-grade solutions without enterprise bureaucracy. We
                    built our reputation one bespoke engagement at a time, delivering the same
                    caliber of strategy, security, and infrastructure used by Fortune 500 companies
                    to businesses, families, and nonprofits who had been systematically underserved.
                  </p>
                  <p>
                    Word travels fast when you fix what others cannot. Our clients, many of whom
                    came to us after exhausting traditional options, began asking a consistent
                    question: <em>"Why aren't you available to everyone?"</em>
                  </p>
                  <p>
                    The answer, for years, was capacity. We believed that maintaining boutique
                    quality required staying small. But as our team matured and our processes
                    crystallized, we realized we had built something scalable without sacrificing
                    soul. Our clients encouraged us to go public, not because they wanted to share
                    us, but because they believed others deserved access to what we had proven we
                    could deliver.
                  </p>
                  <p>
                    <strong>So here we are.</strong> No longer invitation-only, but still
                    uncompromisingly focused on precision, transparency, and results. We bring the
                    same rigor, the same vendor neutrality, and the same refusal to cut corners that
                    our earliest clients relied on. The only difference is that now, you do not need
                    a referral to work with us. You just need a problem worth solving.
                  </p>
                </div>
              </div>
