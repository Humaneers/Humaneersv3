                        ...
                        {CHANGELOG.map((entry, index) => (
                            <div key={entry.version} className="relative pl-8 border-l-2 border-brand-copper/20">
                                ...
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <Badge variant={index === 0 ? "default" : "secondary"} className={index === 0 ? "bg-brand-copper hover:bg-brand-copper-dark" : "bg-gray-200 text-gray-600 hover:bg-gray-300"}>
                                        {entry.date}
                                    </Badge>
                                    {index === 0 && entry.version === APP_VERSION && (
                                        <span className="text-xs font-bold text-brand-copper uppercase tracking-wider">Current</span>
                                    )}
                                </div>
