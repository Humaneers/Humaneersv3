            ...
            <div className="grid gap-6">
              <div className="flex gap-4 p-4 border rounded-lg bg-stone-50">
                ...
                <div>
                  ...
                  <p className="text-sm text-stone-600">
                    We flood Page 1 of Google with controlled, positive assets to push negative
                    links to Page 3+.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 p-4 border rounded-lg bg-stone-50">
                ...
                <div>
                  ...
                  <p className="text-sm text-stone-600">
                    Removing home addresses, phone numbers, and family details from "people search"
                    broker sites.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 p-4 border rounded-lg bg-stone-50">
                ...
                <div>
                  ...
                  <p className="text-sm text-stone-600">
                    Securing accounts during a viral event to prevent hacking and "comment
                    swarming".
                  </p>
                </div>
              </div>
