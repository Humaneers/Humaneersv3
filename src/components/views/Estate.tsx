            ...
            <div className="bg-white">
                ...
                <section className="bg-brand-oxford text-white py-24 relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 relative z-10 text-center">
                        ...
                        <p className="text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-3xl mx-auto mb-10">
                            For homes that run like businesses. We provide enterprise-grade Wi-Fi, vendor management,
                            and 24/7 support for the modern estate.
                        </p>
                        ...
                        <div className="flex flex-col md:flex-row gap-16 items-center">
                            <div className="md:w-1/2">
                                ...
                                <p className="text-brand-slate text-lg mb-6 leading-relaxed">
                                    You have Control4, Savant, multiple Wi-Fi access points, and critical security cameras.
                                    When something breaks, the AV guy blames the ISP, and the ISP blames your router.
                                    We sit in the middle and own the problem.
                                </p>
                                <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-brand-copper">
                                    ...
                                    <ul className="space-y-3 text-sm text-gray-600">
                                        <li className="flex items-center gap-3">
                                            ...
                                            <span>
                                                <strong>Vendor Management:</strong> We talk to the AV/Alarm companies for you.
                                            </span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-brand-copper shrink-0" />
                                            <span>
                                                <strong>Enterprise Wi-Fi:</strong> Heat-mapped, redundant, and monitored 24/7.
                                            </span>
                                        </li>
                                        <li className="flex items-center gap-3">
                                            <CheckCircle2 className="w-5 h-5 text-brand-copper shrink-0" />
                ...
                <section className="py-24 bg-brand-oxford text-white text-center">
                    <div className="container mx-auto px-6">
                        ...
                        <Button
                            onClick={() =>
                                navigate(routePaths.talkToSales, { state: { interest: "Estate / Private Client Services" } })
                            }
