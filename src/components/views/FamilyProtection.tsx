...
import { Home, ShieldCheck, Smartphone, Eye, Wifi } from "lucide-react";
...
export function FamilyProtection() {
  ...
  return (
    <Seo
      title="Humaneers | Family Protection | Enterprise Security at Home"
      description="Secure your home network and personal devices with enterprise-grade security. Protect your family from cyber threats with Humaneers."
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/2">
                ...
                <p className="text-xl text-gray-300 font-light leading-relaxed mb-8">
                  Your home network is the new corporate perimeter. We secure your personal devices
                  with the same rigor we use for Fortune 500 banks.
                </p>
                <Button
                  onClick={() =>
                    navigate(routePaths.talkToSales, { state: { interest: "Family IT" } })
                  }
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-brand-slate text-lg">
                Hackers know that corporate firewalls are tough, so they target the CEO's home iPad
                instead. Once they're on your home Wi-Fi, they can jump to your work laptop. We close
                that gap.
              </p>
            </div>
          ...
          <div className="container mx-auto px-6 flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-300 text-lg mb-6">
                You don't need a technician in your living room to get secure. We configure a
                "Humaneers Secure Gateway" in our Tempe lab and ship it to your home anywhere in the
                US.
              </p>
