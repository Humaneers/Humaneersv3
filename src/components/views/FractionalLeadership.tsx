...
export function FractionalLeadership() {
  ...
  return (
    <Seo
      ...
      description="Strategy without the salary cap. Get a fractional CIO, CISO, or CMO to lead your technology and growth teams."
        ...
        <section className="bg-brand-oxford text-white py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                onClick={() =>
                  navigate(routePaths.talkToSales, { state: { interest: "Fractional Leadership" } })
                }
