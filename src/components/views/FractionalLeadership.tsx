...
export function FractionalLeadership() {
  ...
  return (
    <Seo
      title="Humaneers | Fractional Leadership | vCIO & Strategy"
      description="Get executive-level IT strategy without the full-time cost. Fractional CIO (vCIO) services for small businesses and startups."
      canonicalPath="/fractional-leadership"
    >
        ...
        <section className="bg-brand-oxford text-white py-20">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-3xl mx-auto mb-10">
              You don't need a full-time CIO to have a full-time strategy. Get the roadmap, budget,
              and leadership you need at a fraction of the cost.
            </p>
            <Button
            ...
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p className="text-brand-slate text-lg mb-8 leading-relaxed">
                  Small businesses often get stuck in a reactive cycle—fixing printers and patching
                  servers. A Fractional CIO (vCIO) lifts your gaze to the horizon. We help you use
                  technology as a competitive advantage, not just a utility.
                </p>
                <div className="bg-brand-cream p-6 rounded-lg border-l-4 border-brand-copper">
                  <p className="text-brand-oxford italic font-medium">
                    "Humaneers didn't just fix our wifi; they helped us select the ERP system that
                    doubled our manufacturing throughput."
                  </p>
                  <p className="text-brand-copper text-sm mt-4 font-bold">
                    — CEO, Arizona Manufacturing Firm
                  </p>
                </div>
              </div>
              <div className="space-y-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-brand-oxford mb-2">
                      Quarterly Business Reviews (QBRs)
                    </h3>
                    <p className="text-brand-slate text-sm">
                      Quarterly reviews of stack, security, and budget.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-slate text-sm">
                      Vendor negotiation and a 3-year IT roadmap.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-brand-slate text-sm">
                      Board-ready risk and strategy translation.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-24 bg-brand-cream text-center">
          <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-brand-oxford mb-8">
              Virtual Leadership, Real Results
            </h2>
            <p className="text-brand-slate max-w-2xl mx-auto mb-12">
              Our vCIOs support clients from coast to coast using advanced collaboration tools.
              Whether you're in Seattle or Miami, you get a dedicated executive partner.
            </p>
