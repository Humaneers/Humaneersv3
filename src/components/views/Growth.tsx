...
export function Growth() {
  ...
  return (
    <Seo
      title="Humaneers | Brand Growth | US Market Expansion"
      description="Helping international brands win in the US market. Localize your brand, optimize your strategy, and build trust with American consumers."
      canonicalPath="/brand-growth"
    >
