...
export function Industries() {
  ...
  return (
    <Seo
      ...
      description="Compliance-first IT services for Healthcare (HIPAA), Finance (FINRA), and Legal sectors. We handle the audits so you can handle the business."
        ...
        <section className="bg-brand-oxford text-white py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                onClick={() =>
                  navigate(routePaths.talkToSales, { state: { interest: "Regulated Industries" } })
                }
