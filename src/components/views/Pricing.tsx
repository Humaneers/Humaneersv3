...
export function Pricing() {
  ...
  return (
    <Seo
      ...
      description="Clear pricing for managed IT, family protection, and fractional leadership. No per-device fees for households, no markup on nonprofit licensing."
