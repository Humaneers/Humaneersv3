...
export function Privacy() {
  return (
    <Seo
      ...
      description="Our commitment to protecting your personal data. We are custodians, not owners, of your data. Read our privacy policy."
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg text-brand-slate">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                <strong>Marketing Data</strong>: Your preferences in receiving marketing
                communications and your communication preferences.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>
                <strong>Contract Performance</strong>: Where we need to perform a contract we are
                about to enter into or have entered with you.
              </li>
              <li>
                <strong>Legitimate Interests</strong>: Where it is necessary for our legitimate
                business interests and your interests and fundamental rights do not override those
                interests.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                Ensuring processors are Privacy Shield certified or have equivalent protections.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                <strong>Right to Opt-Out</strong>: We do not sell personal information. If our
            ...
            <p>
              ...
              100% secure. We cannot guarantee absolute security but maintain industry-standard
              protections.
            </p>
