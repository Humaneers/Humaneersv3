...
export function Resources() {
  ...
  return (
    <Seo
      ...
      description="Free operational playbooks, security checklists, and strategic guides for modern businesses and families."
            ...
            <div className="space-y-4">
              <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                ...
                <p className="text-brand-slate text-sm">
                  Any outage affecting &gt;50% of users, a confirmed data breach, or active
                  ransomware attack. P1 incidents trigger our 15-minute SLA response protocol.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                <h4 className="font-bold text-brand-oxford mb-2">
