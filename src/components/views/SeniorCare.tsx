            ...
            <div className="bg-white">
                            ...
                            <div className="space-y-6">
                                <div className="bg-white p-6 rounded-xl shadow-md flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-brand-slate text-sm">
                                            We declutter iPads and computers. We remove confusing apps, enlarge fonts,
                                            and set up "One-Click" video calls to family.
                                        </p>
                                    </div>
                                </div>
                                <div className="bg-white p-6 rounded-xl shadow-md flex items-start gap-4">
                                ...
                                <div className="bg-white p-6 rounded-xl shadow-md flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-brand-slate text-sm">
                                            Your parents can call us. We never talk down to them. We listen,
                                            explain slowly, and fix the issue with kindness.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <section className="py-24 bg-white">
                    <div className="container mx-auto px-6 text-center">
                        <h2 className="text-3xl font-bold text-brand-oxford mb-12">Peace of Mind for the Whole Family</h2>
                        <div className="grid md:grid-cols-3 gap-8 text-left">
                            <div className="p-8 border rounded-2xl hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-600">
                                    We give you (the adult child) "God Mode" access to oversee their device security status remotely.
                                </p>
                            </div>
                            <div className="p-8 border rounded-2xl hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-600">
                                    They can press one button to get help. No navigating complex support numbers or automated menus.
                                </p>
                            </div>
                            <div className="p-8 border rounded-2xl hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-600">
                                    We help organize passwords and accounts so that their digital legacy is secure and accessible to executors.
                                </p>
                            </div>
                        </div>
                        <div className="mt-16">
                            <Button
                                onClick={() => navigate(routePaths.talkToSales, { state: { interest: "Senior Care Plan" } })}
