            ...
            <div>
              ...
              <div className="bg-red-50 p-6 rounded-xl border border-red-100 mb-6">
                ...
                <p className="text-red-700 text-sm">
                  Seniors lose over $3 billion annually to elder financial fraud. 90% of these scams
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-brand-slate text-sm">
                    Your parents can call us. We never talk down to them. We listen, explain slowly,
                    and fix the issue with kindness.
                  </p>
                </div>
              </div>
            </div>
