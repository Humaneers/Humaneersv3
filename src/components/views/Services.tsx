...
export function Services() {
  ...
  return (
    <Seo
      ...
      description="Full-spectrum IT support: Managed IT, Brand Growth, Family Protection, and Crisis Management. 100% US-based engineering."
        ...
        <section className="bg-brand-oxford text-white py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 font-light leading-relaxed max-w-3xl mx-auto mb-8">
              From the server room to the board room, we provide the technology and strategy you
              need to scale.
            </p>
          </div>
        </section>
