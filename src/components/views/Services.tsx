      ...
      <section className="bg-brand-oxford text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center justify-center p-3 bg-brand-copper/20 rounded-full mb-6">
              ...
              <span className="text-brand-copper font-bold uppercase tracking-widest text-sm">Full Spectrum Support</span>
          </div>
         ...
         <div className="container mx-auto px-6 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
               <div className="p-6">
                  ...
                  <p className="text-brand-slate">No offshore call centers. Every engineer and strategist is local.</p>
               </div>
               <div className="p-6">
                  ...
                  <p className="text-brand-slate">Enterprise-grade security controls applied to every client, big or small.</p>
               </div>
               <div className="p-6">
                  ...
                  <p className="text-brand-slate">We build on standard stacks (Microsoft, AWS) so you own your infrastructure.</p>
               </div>
            </div>
         </div>
      </section>
