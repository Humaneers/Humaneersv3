...
export function Status() {
  const systems = [
    ...
    {
      name: "Secure Endpoint Monitoring",
      status: "Operational",
      uptime: "100%",
      lastIncident: "None",
    },
    {
      name: "Client Portal (HumaneOS)",
      status: "Operational",
      uptime: "99.95%",
  ...
  return (
    <Seo
      ...
      description="Real-time status of Humaneers systems and services. View uptime incidents and scheduled maintenance."
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="max-w-4xl mx-auto space-y-8">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 text-xs text-gray-500 mt-1">
                          <span className="flex items-center gap-1">
                            <Clock size={12} /> Uptime: {sys.uptime}
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              <h3 className="text-xl font-bold text-brand-oxford mb-6">
