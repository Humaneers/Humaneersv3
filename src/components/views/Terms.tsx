...
export function Terms() {
  return (
    <Seo
      ...
      description="Legal agreement and service terms for Humaneers clients. SLAs, liability, and usage policies."
      canonicalPath="/terms"
    >
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg text-brand-slate">
            ...
            <p>
              ...
              ("Humaneers," "we," "us," or "our") concerning your access to and use of our website
              and services. By accessing our website or engaging our services, you agree to be bound
              by these Terms and our Privacy Policy. If you do not agree with these Terms, you must
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                <strong>Crisis Management & Incident Response</strong>: Emergency IT support,
                security incident handling, and 24/7 critical issue resolution.
              </li>
              <li>
              ...
              <li>
                <strong>Fractional Leadership</strong>: Part-time CIO (Chief Information Officer)
                and CMO (Chief Marketing Officer) services.
              </li>
            </ul>
            <p>
            ...
            <p>
              For clients with active Managed IT service contracts, we commit to the following
              service levels:
            </p>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                Credits must be requested within 30 days of the incident and are your sole remedy
                for SLA breaches.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                <strong>Confidentiality</strong>: Confidential information is protected as
                committed.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                Maintain backups of critical data (we provide backup services but client ownership
                of data remains).
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>
                <strong>Late Payments</strong>: Late fees of 1.5% per month (18% APR) apply to
                overdue balances.
              </li>
              <li>
                <strong>Suspension</strong>: Services may be suspended for accounts more than 30
                days past due after written notice.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>
                <strong>Monthly Contracts</strong>: 30-day notice required for cancellation by
                either party.
              </li>
              <li>
            ...
            <p>
              ...
              ownership over client data and will not use it except as necessary to provide
              services.
            </p>
            ...
            <p>
              For custom development or deliverables created specifically for your project,
              ownership transfers to you upon full payment unless otherwise agreed in writing.
            </p>
            ...
            <p>
              ...
              services, (b) violation of laws or third-party rights, (c) your data or content, or
              (d) unauthorized access due to your failure to secure credentials.
            </p>
            ...
            <p>
              Before filing a claim, parties agree to attempt informal resolution by providing
              written notice describing the dispute and proposed resolution.
            </p>
            ...
            <p>
              ...
              regard to conflict of law principles. Any litigation shall be brought exclusively in
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>
                <strong>Entire Agreement</strong>: These Terms, together with your service
              ...
              <li>
                <strong>Notices</strong>: Legal notices must be sent in writing to
                hello@humaneers.dev or the address in your service agreement.
              </li>
            </ul>
