  ...
  return (
    <div className="container mx-auto px-6 py-24 max-w-4xl text-brand-slate text-lg leading-relaxed">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Managed IT Services</strong>: Cloud infrastructure management, system monitoring,
        ...
        <li>
          <strong>Fractional Leadership</strong>: Part-time CIO (Chief Information Officer) and CMO
          (Chief Marketing Officer) services.
        </li>
      </ul>
      <p>
        Services are provided under individual service agreements that incorporate these Terms by
        reference.
      </p>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Cloud Infrastructure</strong>: 99.9% uptime for managed cloud services (excludes
        ...
        <li>
          <strong>Scheduled Maintenance</strong>: Performed during agreed maintenance windows with
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Critical (P1)</strong>: System down or data breach - 15-minute initial response,
          4-hour resolution target. Emergency phone support available 24/7.
        </li>
        <li>
          <strong>High (P2)</strong>: Major functionality impaired - 1-hour initial response, 8-hour
          resolution target.
        </li>
        <li>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          Credits must be requested within 30 days of the incident and are your sole remedy for SLA
          breaches.
        </li>
      </ul>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          Maintain backups of critical data (we provide backup services but client ownership of data
          remains).
        </li>
      </ul>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Billing Cycles</strong>: Services are billed monthly in advance unless otherwise
          agreed in your service agreement.
        </li>
        <li>
        ...
        <li>
          <strong>Suspension</strong>: Services may be suspended for accounts more than 30 days past
          due after written notice.
        </li>
        <li>
      ...
      <p>
        Either party may terminate immediately for material breach if the breach is not cured within
        15 days of written notice. Humaneers may terminate immediately for non-payment, violation of
        acceptable use policies, or illegal activity.
      </p>
      ...
      <p>
        You retain all rights, title, and interest in your data and content. We claim no ownership
        over client data and will not use it except as necessary to provide services.
      </p>

      <h3 className="text-xl font-semibold text-brand-oxford mt-6 mb-3">8.2 Humaneers IP</h3>
      <p>
        Our proprietary tools, methodologies, processes, and software remain our exclusive property.
        Services grants no transfer of IP rights except as explicitly stated in individual
        agreements.
      </p>
      ...
      <p>
        Confidentiality obligations survive termination of services and continue indefinitely except
      ...
      <p>
        ...
        aggregate liability shall exceed the total fees paid by client in the 12 months preceding
        the claim.
      </p>
      ...
      <p>
        ...
        damages, including lost profits, lost data, or business interruption, even if advised of the
        possibility.
      </p>
      ...
      <p>
        You will defend and indemnify us against claims arising from: (a) your misuse of services,
        (b) violation of laws or third-party rights, (c) your data or content, or (d) unauthorized
        access due to your failure to secure credentials.
      </p>
      ...
      <p>
        ...
        consistent with industry standards. For material breach of this warranty, your sole remedy
        is re-performance of the deficient services.
      </p>
      ...
      <p>
        We may modify these Terms at any time by posting updated terms on our website. For material
        changes affecting active service agreements, we will provide 30 days' advance notice via
        email. Continued use of services after changes take effect constitutes acceptance.
      </p>
      ...
      <p>
        ...
        Arbitration shall be conducted in Tempe, Arizona.
      </p>
      ...
      <p>
        ...
        to conflict of law principles. Any litigation shall be brought exclusively in the state or
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          <strong>Severability</strong>: If any provision is found invalid, the remaining provisions
        ...
        <li>
          <strong>Notices</strong>: Legal notices must be sent in writing to hello@humaneers.dev or
          the address in your service agreement.
        </li>
      </ul>
