        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="hidden md:grid md:grid-cols-12 gap-8 items-start">
            ...
            <div className="col-span-12 md:col-span-7 sticky top-24">
              <div className="bg-white/60 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/40 p-8 relative overflow-hidden flex flex-col justify-center min-h-[300px]">
