...
export function PrivacyClient() {
  return (
    <div className="container mx-auto px-6 py-24 max-w-4xl text-brand-slate text-lg leading-relaxed">
      <h1 className="text-4xl md:text-5xl font-bold text-brand-oxford mb-8">Privacy Policy</h1>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Identity Data</strong>: First name, last name, username or similar identifier, job
          title, company name.
        </li>
        <li>
        ...
        <li>
          ...
          location data, browser plug-in types and versions, operating system and platform.
        </li>
        <li>
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          ...
          "Support Ticket", "Newsletter"). Your session history (pages visited) is stored locally on
          your device and is only transmitted to us when you actively click a submission button.
        </li>
        <li>
          <strong>Automated technologies</strong>: As you interact with our website, we may
          automatically collect Technical Data using cookies, server logs, and similar technologies.
          We prioritize ephemeral local storage over persistent cookies where possible.{" "}
          <strong>
      ...
      <p>
        We will only use your personal data when the law allows us to. Under GDPR, our lawful bases
        for processing include:
      </p>
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Contract Performance</strong>: Where we need to perform a contract we are about to
          enter into or have entered with you.
        </li>
        <li>
      ...
      <p>
        ...
        residence, including the United States. Where we transfer data outside the European Economic
        Area (EEA), we ensure appropriate safeguards are in place, such as:
      </p>
      <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        <li>
          <strong>Active clients</strong>: For the duration of the service relationship plus 7 years
          for accounting and legal compliance.
        </li>
        <li>
          <strong>Prospects and inquiries</strong>: Up to 3 years from last interaction, unless you
      ...
      <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <li>
          We comply with all applicable laws, including the Children's Online Privacy Protection Act
          (COPPA).
        </li>
      </ul>
      <p>
      ...
      <p>
        <strong>In all cases, client data remains client data.</strong> We act solely as custodians
        and data processors. We do not claim ownership of your personal information, business data,
        or intellectual property. You retain full rights to your data at all times, and we will
        return or delete your data upon termination of service in accordance with our retention
        policy.
      </p>

      <h2 className="text-2xl font-bold text-brand-oxford mt-8 mb-4">15. Changes to This Policy</h2>
      <p>
        We may update this privacy policy from time to time to reflect changes in our practices or
        legal requirements. We will notify you of significant changes by posting the updated policy
        on our website and updating the "Last updated" date. For material changes, we may provide
