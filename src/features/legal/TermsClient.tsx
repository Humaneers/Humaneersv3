...
/**
 * This file stays hand-written: it is the authority for the SLA figures, and
 * nothing here reads them from src/data/pricing.ts. Cut 6 changed the layout
 * and the type only. No word of the agreement changed.
 */
export function TermsClient() {
  return (
    <>
      <PageHeader heading="Terms of Service" description="Last updated: Feb 2, 2026" />

      <ProseSection>
        <h2>1. Agreement to Terms</h2>
        <p>
          These Terms of Service ("Terms") constitute a legally binding agreement between you
          (whether personally or on behalf of an entity) and Humaneers, LLC ("Humaneers," "we,"
          "us," or "our") concerning your access to and use of our website and services. By
          accessing our website or engaging our services, you agree to be bound by these Terms and
          our Privacy Policy. If you do not agree with these Terms, you must not access the website
          or use our services.
        </p>
        ...
        <h3>3.2 Support Response Times</h3>
        <ul>
          <li>
        ...
        <h3>4.1 Data Security Commitments</h3>
        <ul>
        ...
        <h3>8.1 Client Data Ownership</h3>
        <p>
        ...
        <p>
          ...
          <br />
          Email: <a href="mailto:hello@humaneers.dev">hello@humaneers.dev</a>
          <br />
          Legal: <a href="mailto:legal@humaneers.dev">legal@humaneers.dev</a>
          <br />
          Security: <a href="mailto:security@humaneers.dev">security@humaneers.dev</a>
        </p>
      </ProseSection>
    </>
  );
