        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <Input
              ...
              type="text"
              placeholder="Contact us for specific resource requests..."
          ...
          {filteredResources.map((resource) => (
            ...
            >
              ...
              <div className="pt-4 border-t border-gray-100 flex justify-between items-center mt-auto">
                ...
                <span className="text-brand-copper text-sm font-medium">Available to clients</span>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="bg-white p-8 rounded-xl border-l-4 border-brand-oxford shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100">
                ...
                <span className="text-sm text-gray-500">Available to active clients</span>
              </div>
            </div>
          </div>
